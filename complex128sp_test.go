...
var MarshalComplex128spTestCases = []marshalTestCase{
	{
		line: line(),
		input: func() map[string]json.Marshaler {
			var c, c2 complex128 = complex(1, 23), complex(3, 21)
			return map[string]json.Marshaler{"slice of complex128 pointers": log0.Complex128sp(&c, &c2)}
		}(),
		expected:     "1+23i 3+21i",
		expectedText: "1+23i 3+21i",
		expectedJSON: `{
			"slice of complex128 pointers":["1+23i","3+21i"]
		}`,
	},
	{
		line:         line(),
		input:        map[string]json.Marshaler{"slice of nil complex128 pointers": log0.Complex128sp(nil, nil)},
		expected:     "null null",
	...
	{
		line:         line(),
		input:        map[string]json.Marshaler{"slice without complex128 pointers": log0.Complex128sp()},
		expected:     "null",
		expectedText: "null",
		expectedJSON: `{
...
func TestMarshalComplex128sp(t *testing.T) {
	_, testFile, _, _ := runtime.Caller(0)
	testMarshal(t, testFile, MarshalComplex128spTestCases)
}
